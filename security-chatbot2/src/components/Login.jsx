...
const Login = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-login-gradient p-4 animate-fade-in">
      <div className="w-full max-w-md glass-effect p-8 rounded-xl shadow-lg">
        <h2 className="text-2xl font-bold text-white mb-6 text-center">Security Chatbot Login</h2>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full p-3 pl-10 rounded-lg bg-transparent text-white border border-gray-500 focus:border-primary-blue focus:outline-none transition"
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 pl-10 pr-10 rounded-lg bg-transparent text-white border border-gray-500 focus:border-primary-blue focus:outline-none transition"
